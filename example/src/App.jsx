...
function App() {
  ...
  //         console.log('New Avatar URL:', newAvatarUrl); // 添加调试信息
  ...
  //           localStorage.setItem('avatar', newAvatarUrl); // 更新本地存储
  //         } else {
  //           console.error('Error updating avatar:', updateResponse.data.message);
  //           alert('头像更新失败');
  //         }
  //       } else {
